...
class Jam:
    ...
    def komponen(self):
        ...
        self.jam = Label(layarJam, textvariable=self.teksJam,font=('Timnes New Roman', 45, 'bold'),bg = "light green",fg="black")
        self.jam.pack()

        self.teks = Label(text="Belajar Buat Jam + Alarm by Sendy")
        self.teks.pack()
    ...
    def perbarui(self):
        ...
        self.timer = self.parent.after(1000, self.perbarui)
